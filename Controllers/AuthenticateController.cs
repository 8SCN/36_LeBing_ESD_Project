...
namespace EmployeeService.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public AuthenticateController(BookingDbContext dbContext, UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration)
        {
